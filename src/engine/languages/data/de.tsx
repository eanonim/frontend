...
export default {
  ...
  chat_onboard:
    "Wenn Ihr Gesprächspartner Spam, Werbung oder verbotene Inhalte verschickt - drücken Sie die Nachricht lange und wählen Sie «Beschwerde». Anonymität ist garantiert.",
  language: "Sprache",
  rating: "Bewertung",
  tasks: "Aufgaben",
  chat_deleted: {
