...
export default {
  ...
  chat_onboard:
    "If the interlocutor sends spam, advertisements or prohibited materials - press and hold the message, then select «Complain». Anonymity is guaranteed.",
  language: "Language",
  rating: "Rating",
  tasks: "Tasks",
  chat_deleted: {
  ...
  unavailable: (time: string) => `Unavailable until ${time}`,
  purchased: "Purchased",
