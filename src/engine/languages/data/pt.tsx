...
export default {
  ...
  chat_onboard:
    "Se o interlocutor enviar spam, propaganda ou materiais proibidos - pressione e segure a mensagem, depois selecione «Reclamar». O anonimato é garantido.",
  language: "Idioma",
  ...
  banner: {
    title: "Aqui começa a comunicação anônima",
    subtitle:
      "Ajuste seus interesses, escolha um interlocutor – e comece o diálogo!",
  },
  premium: "Premium",
  premium_subtitle:
  ...
  searchTitle: "Procurando um parceiro de conversa…",
  searchSubtitle:
    "A cada segundo, alguém começa um diálogo no ANChat. Seja o próximo!",
  searchInterests: {
    music: "Música",
    travel: "Viagem",
    sport: "Esporte",
  ...
  unavailable: (time: string) => `Indisponível até ${time}`,
  purchased: "Comprado",
